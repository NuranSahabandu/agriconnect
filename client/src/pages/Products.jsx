...
export default function Products() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 pb-20">
      ...
      {/* Registration / Login Prompt Banner if not logged in */}
      {!isAuthenticated && (
        <div className="bg-amber-50 border-b border-amber-200 px-4 py-3 text-xs sm:text-sm text-amber-900">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <span className="text-base">🔔</span>
              <span>
                <strong>Register as a Farmer or Customer</strong> to save your profile into MongoDB Atlas!
              </span>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 bg-emerald-900/60 border border-emerald-400/30 px-3 py-1 rounded-full text-xs tracking-wide uppercase font-semibold text-emerald-200 mb-3">
              ...
              {isAuthenticated && (
                <span className="bg-emerald-600 px-2 py-0.5 rounded-full text-[10px] text-white font-bold">
